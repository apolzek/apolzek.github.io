...
```
/etc/apt/: Arquivos de configuração do apt.
/var/lib/apt/: Cache do apt com informações sobre pacotes.
/var/cache/apt/archives/: Armazena pacotes .deb baixados.
/var/cache/apt/pkgcache.bin: Cache binária dos pacotes disponíveis.
/var/cache/apt/srcpkgcache.bin: Cache binária dos pacotes de origem.
/var/log/apt/: Arquivos de log das operações do apt.
/etc/apt/sources.list.d/: Diretório para arquivos .list de repositórios adicionais.
```
