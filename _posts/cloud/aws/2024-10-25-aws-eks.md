...
Esta política permite listar todas as instâncias EC2 em uma região específica
```json
{
    "Version": "2012-10-17",
    "Statement": [
...
Esta política permite listar, criar, excluir e gerenciar buckets no Amazon S3
```json
{
    "Version": "2012-10-17",
    "Statement": [
