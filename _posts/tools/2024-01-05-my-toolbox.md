...
| HAProxy        | HAProxy (High Availability Proxy) é um balanceador de carga e servidor proxy de código aberto para aplicações TCP e HTTP desenvolvido em Linux       |
| Prometheus     | An open-source monitoring system with a dimensional data model, flexible query language, efficient time series database and modern alerting approach |
| Grafana        | Grafana is the open source analytics & monitoring solution for every database                                                                        |
| OpenTelemetry  | Open Source, Vendor Neutral. 100% Free and Open Source, OpenTelemetry is adopted and supported by industry leaders in the observability space        |
| FluentD        | Fluentd is a cloud native logging solution to unify data collection and consumption                                                                  |
| Fluentbit      | Fluentd is an open source data collector, which lets you unify the data collection and consumption for a better use and understanding of data        |
| RabbitMQ       | RabbitMQ is a message-queueing software also known as a message broker or queue manager                                                              |
| Loki           | Loki is a horizontally scalable, highly available, multi-tenant log aggregation system inspired by Prometheus                                        |
| Promtail       | Promtail is an agent which ships the contents of local logs to a private Grafana Loki instance or Grafana Cloud                                      |
| Github Actions | Automate your workflow from idea to production                                                                                                       |
| Gitlab CI      | Build, test, package, and deploy secure software in a fraction of the time                                                                           |
