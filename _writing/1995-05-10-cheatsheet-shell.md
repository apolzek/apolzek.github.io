...
function exitMsg {
    echo "you sent a signal to end, bye-bye !!"
    # command here
    exit
}
...
echo "debug output should be gone now"
```
...
substring=${original:6:10}  # Extracts "is amazing"
...
# Output: Length of the string: 17 characters
```
