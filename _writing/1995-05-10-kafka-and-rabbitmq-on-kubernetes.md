...
**saving your time**: *manifests to deploy kafka and rabbitmq as StatefulSets in kind (k8s local)*
...
kafka-topics.sh --list --bootstrap-server kafka-svc:9092
# Produce message
  ...
  template:
    ...
    spec:
      ...
      - name: config
        ...
        resources: # QoS Guaranteed — limits equal to requests
          limits:
            cpu: 1
            memory: 2Gi
          requests:
